...
def locate_cards(cards, query):
    low, high = 0, len(cards) - 1  # keep track of search space

    while low <= high:  # making sure that there is at least one element to search in the list of cards
        mid = (low + high) // 2  # using integer division to avoid floating point numbers
        mid_num = cards[mid]
        print("Low: ", low, "High: ", high, "Middle Num: ", mid_num)
